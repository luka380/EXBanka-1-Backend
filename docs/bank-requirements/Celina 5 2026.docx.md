# Komunikacija izmedju banaka {#komunikacija-izmedju-banaka}

[Komunikacija izmedju banaka	0](#komunikacija-izmedju-banaka)

[Komunikacija između banaka	1](#komunikacija-između-banaka)

[Plaćanja	1](#plaćanja)

[Primer	2](#primer)

[OTC Trgovina	3](#otc-trgovina)

[Dobavljanje OTC ponuda druge banke	3](#dobavljanje-otc-ponuda-druge-banke)

[Pregovaranje	3](#pregovaranje)

[**Primer 1 \- pregovaranje**	3](#primer-1---pregovaranje)

[**Primer 2 \- postignut dogovor**	4](#primer-2---postignut-dogovor)

[Izvršavanje kupoprodaje	4](#izvršavanje-kupoprodaje)

[**Primer 1 \- iskorišćavanje opcionog ugovora**	6](#primer-1---iskorišćavanje-opcionog-ugovora)

[**Primer 2 \- ne iskorišćavanje opcionog ugovora**	7](#primer-2---ne-iskorišćavanje-opcionog-ugovora)

[Obračun poreza	7](#obračun-poreza)

[**Prodavac prima premiju (OTC)**	7](#prodavac-prima-premiju-\(otc\))

[**Kupac iskorišćava opciju (OTC)**	7](#kupac-iskorišćava-opciju-\(otc\))

[**Opcija istekne neiskorišćena (OTC)**	7](#opcija-istekne-neiskorišćena-\(otc\))
...
#### Obračun poreza {#obračun-poreza}

Proširenje obračuna poreza na opcije i premije, iskorišćavanje opcija i istekle opcije

##### **Prodavac prima premiju (OTC)** {#prodavac-prima-premiju-(otc)}

Kada se sklopi opcioni ugovor, prodavac prima premiju na račun. Taj prihod je oporeziv.   
Porez \= 15% × premija. 

Primer: Marko primi premiju od $1150, porez je $172.50 

##### 

##### **Kupac iskorišćava opciju (OTC)** {#kupac-iskorišćava-opciju-(otc)}

Kupac kupuje akcije po strike price-u, tržišna cena je veća. Razlika je prihod koji je oporeziv. Porez \= 15% × ((tržišna cena − strike price) × količina akcija − premija). 

Primer: kupac iskoristi opciju za 50 AAPL akcija, strike $200, tržišna $250, premiju platio $1150 Oporezivi iznos \= ($250 − $200) × 50 \- $1150 \= $1350, porez je $202.50 

##### **Opcija istekne neiskorišćena (OTC)** {#opcija-istekne-neiskorišćena-(otc)}

Kupac: izgubljena premija je gubitak koji umanjuje ukupnu kapitalnu dobit za taj mesec Prodavac: nema dodatnog poreza (premiju je već oporezovao kad ju je primio) 

Primer: kupac platio premiju $1150, opcija je istekla, gubitak od $1150 se oduzima od dobiti tog meseca 

##### **Izuzetak** {#izuzetak}

Aktuari koji trguju u ime banke ne plaćaju 15% porez. Profit od opcija (uključujući premije) ide u Profit Banke. Isto kao za dividende.
